...
# diferentes. Acrescente um bloco de código que reescreva a tupla e, em seguida, use um laço for para exibir cada um dos itens do cardápio revisado.

buffer_foods = ("massas", "sushi", "churrasco", "salgados", "sopas")

print("\nCardapio original:")
for foods in  buffer_foods:
    print(foods.title())

#buffer_foods[0] = "comidas"
print("\nCardapio modificado:")
buffer_foods = ("massas", "sushi", "arrabe", "sopas", "doces")
for foods in buffer_foods:
    print(foods.title())